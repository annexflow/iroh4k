...
afterEvaluate {
    ...
    // ABIs are derived from the selected androidNative targets. When none are selected the task
    // is neither created nor wired, so no Android NDK / cargo-ndk is needed.
