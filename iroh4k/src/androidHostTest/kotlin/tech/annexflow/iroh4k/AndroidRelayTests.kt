...
/**
 * Exercises the relay surface from the Android target: the same shared `CommonRelayTests`
 * bodies as `JvmRelayTests`, run under Robolectric on the host JVM against `androidMain`'s
 * loader.
 */
@RunWith(RobolectricTestRunner::class)
@Config(sdk = [34])
class AndroidRelayTests {
