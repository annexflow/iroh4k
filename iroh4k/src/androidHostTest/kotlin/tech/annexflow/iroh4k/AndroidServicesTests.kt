...
/**
 * Exercises the services surface from the Android target: the same shared
 * `CommonServicesTests` bodies as `JvmServicesTests`, run under Robolectric on the host JVM
